...
void setup()
{
  ...
  myGLCD.fillScr(myTFT.ConvertRGB(WHITE));
 
  //X, Y, radius, thickness, startAngle, stopAngle, color
  myTFT.drawArc(160, 120, 60, 20, 0, 180, myTFT.ConvertRGB(BLUE));
}
...
void loop()
{
  ...
  myGLCD.setBackColor(myTFT.ConvertRGB(WHITE));
  myGLCD.setColor(myTFT.ConvertRGB(BLACK));
