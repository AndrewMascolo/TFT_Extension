...
TFT_Extension myTFT(&myGLCD, &myTouch); // CHANGED SINCE V1.4
...
void setup()
{
  ...
  myTFT.ExtSetup();// CHANGED SINCE V1.4
...
{ 
  ...
  byte red = map(myTFT.HorSlider(20, 20, 210, 50, 0, RED, LTR), 0, 100, 0, 255); // LTR = Left to Right, RTL = Right to Left
